  ...
  template: `
    <div class="page">
      ...
      @if (orgStore.publishSuccess()) {
        <p-message
          severity="success"
          text="Event berhasil dipublikasi! Kamu akan diarahkan ke daftar event..."
        ...
        @switch (currentStep()) {
          @case (0) {
            ...
            <form [formGroup]="step1Form">
              ...
              <div class="field">
                ...
                ></textarea>
                @if (
                  step1Form.get('description')?.invalid && step1Form.get('description')?.touched
                ) {
            ...
            <form [formGroup]="step2Form">
              <div class="field">
                ...
                <div class="venue-toggle">
                  <div
                    class="venue-option"
                    [class.selected]="step2Form.get('venueType')?.value === 'PHYSICAL'"
                  ...
                  <div
                    class="venue-option"
                    [class.selected]="step2Form.get('venueType')?.value === 'ONLINE'"
          ...
          @case (2) {
            ...
            <button
              ...
              outlined
              (click)="addTicketType()"
              style="border-radius: 9999px; margin-top: 8px;"
            ></button>
          ...
          @case (3) {
            ...
            <div style="margin-bottom: 24px;">
              ...
              <div class="review-row">
                ...
                <span class="review-value">{{
                  step2Form.get('venueType')?.value === 'PHYSICAL' ? 'Fisik' : 'Online'
                }}</span>
              </div>
              <div class="review-row">
                <span class="review-label">Lokasi</span>
                <span class="review-value">{{
                  step2Form.get('venueName')?.value || step2Form.get('onlineUrl')?.value
                }}</span>
              </div>
              <div class="review-row">
                <span class="review-label">Tanggal</span>
                <span class="review-value">{{
                  step2Form.get('startAt')?.value | date: 'd MMM yyyy, HH:mm'
                }}</span>
              </div>
              <div class="review-row">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
              <button
                ...
                [loading]="orgStore.isSaving()"
                (click)="saveDraft()"
                outlined
                style="border-radius: 9999px; flex: 1;"
              ></button>
              <button
                pButton
                type="button"
                ...
                style="border-radius: 9999px; background: #6C63FF; border-color: #6C63FF; flex: 1;"
              ></button>
            </div>
          }
        }
        ...
        @if (currentStep() < 3) {
          <div class="step-nav">
            ...
            <button
              pButton
              type="button"
              [label]="currentStep() === 2 ? 'Lanjut ke Review →' : 'Lanjut →'"
              (click)="nextStep()"
...
export class EventFormComponent implements OnInit, OnDestroy {
  ...
  readonly errorMessage = computed(() => {
    ...
    if (code === 'EVENT_NOT_MODIFIABLE')
      return 'Event tidak bisa diubah (kurang dari 6 jam sebelum acara).';
  ...
  removeTicketType(i: number) {
    if (this.ticketTypes.length > 1) this.ticketTypes.removeAt(i);
  }
  ...
  prevStep() {
    this.orgStore.setStep(Math.max(0, this.currentStep() - 1));
  }
