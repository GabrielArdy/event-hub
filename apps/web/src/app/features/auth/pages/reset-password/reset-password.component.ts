      ...
      <div class="card">
        @if (authStore.resetPasswordSuccess()) {
          <div class="success-box">
            ...
            <p style="color: #6B7280; font-size: 0.875rem;">Kamu bisa masuk dengan password baru.</p>
          ...
          @if (!token) {
            <p-message severity="error" text="Link reset tidak valid atau sudah kadaluarsa." styleClass="w-full mb-3" />
          }
          @if (authStore.error()) {
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()">
            <div class="field">
              ...
              <p-password id="password" formControlName="password" [toggleMask]="true"
                styleClass="w-full" inputStyleClass="w-full" placeholder="Min. 8 karakter" />
            ...
            <button pButton type="submit" label="Simpan Password Baru"
              [loading]="authStore.isLoading()" [disabled]="form.invalid || authStore.isLoading() || !token"
